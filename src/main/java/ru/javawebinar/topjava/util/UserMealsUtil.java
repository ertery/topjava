...
public class UserMealsUtil {
    public static final List<UserMeal> MEAL_LIST_1 = Arrays.asList(
    ...
    public static final List<UserMeal> MEAL_LIST_2 = Arrays.asList(
            ...
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 29, 13, 0), "Обед", 800),
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 29, 20, 0), "Ужин", 600),
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 28, 10, 0), "Завтрак", 1000),
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 28, 13, 0), "Обед", 500),
            new UserMeal(LocalDateTime.of(2015, Month.MAY, 28, 20, 0), "Ужин", 610)
    );

    public static final int DEFAULT_CALORIES_PER_DAY = 2000;

    public static void main(String[] args) {
        List<UserMealWithExceed> filteredMealsWithExceeded = getFilteredWithExceeded(MEAL_LIST_1, LocalTime.of(7, 0), LocalTime.of(12, 0), DEFAULT_CALORIES_PER_DAY);
        filteredMealsWithExceeded.forEach(System.out::println);

        System.out.println(getFilteredWithExceededByCycle(MEAL_LIST_1, LocalTime.of(7, 0), LocalTime.of(12, 0), DEFAULT_CALORIES_PER_DAY));
    }
    ...
    public static List<UserMealWithExceed> getFilteredWithExceededByCycle(List<UserMeal> mealList, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
        ...
        for (UserMeal meal : mealList) {
            ...
            if (TimeUtil.isBetweenTime(dateTime.toLocalTime(), startTime, endTime)) {
